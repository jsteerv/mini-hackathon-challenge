...
This script deploys the Obsidian AI Agent stack with different configurations:
...
def main():
    parser = argparse.ArgumentParser(
        description='Deploy the Obsidian AI Agent stack',
...
Examples:
  ...
  python deploy.py --down --type cloud
    ...
    parser.add_argument(
        '--project', 
        default='obsidian-agent',
        help='Docker Compose project name (default: obsidian-agent)'
    )
